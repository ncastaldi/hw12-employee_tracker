...
const viewMenu = require("./viewMenuActions.js");
const addMenuActions = require("./addMenuActions.js");
...
module.exports = {
    ...
    addSubMenu: function () {
        ...
        inquirer.prompt(
            ...
            switch (menuAction) {
                case "Department":
                    addMenuActions.addDepartment();
                    break;
                case "Employee":
                    addMenuActions.addEmployee();
                    break;
                case "Role":
                    addMenuActions.addRole();
                    break;
                default:
                    // Clear screen before prompting user
                    clear();
